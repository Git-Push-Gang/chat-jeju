...
- 위 프로젝트는 단순한 편의 제공을 넘어 지역 경제 성장에 기여하는 것을 목표로 합니다. 'Chat JEJU’ 를 통해 잘 알려지지 않은 지역 사업체들을 조명하여 지역 사업가들에게 새로운 기회를 제공하고, 관광 수익을 지역 내에
고르게 분배하고자 합니다. 이를 통해 지역 경제를 활성화하고, 과도하게 붐비는 관광지를 분산시켜 다양한 곳에서 지속 가능한 관광이 이루어지는 데 기여하고 싶습니다. 또한 다국어 지원을 통해 외국인
관광객들의 접근성을 높이고, 제주도 여행 경험을 향상시키고자 합니다. 24시간 이용 가능한 서비스는 고객 만족도 역시 크게 높일 수 있다고 생각합니다.
